...
class S3StorageProvider(StorageProvider):
    def __init__(self):
        # Lazy import — only needed when S3 provider is selected
        import boto3
...
class GCSStorageProvider(StorageProvider):
    def __init__(self):
        # Lazy import — only needed when GCS provider is selected
...
class AzureStorageProvider(StorageProvider):
    def __init__(self):
        # Lazy import — only needed when Azure provider is selected
