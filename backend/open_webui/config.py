...
# Pipecat Config
PIPECAT_ENABLED = PersistentConfig(
    "PIPECAT_ENABLED",
    "audio.pipecat.enabled",
    os.environ.get("PIPECAT_ENABLED", "False").lower() == "true",
)

PIPECAT_API_URL = PersistentConfig(
    "PIPECAT_API_URL",
    "audio.pipecat.url",
    os.environ.get("PIPECAT_API_URL", "http://localhost:7860"),
)

PIPECAT_CONNECTION_MODE = PersistentConfig(
    "PIPECAT_CONNECTION_MODE",
    "audio.pipecat.connection_mode",
    os.environ.get("PIPECAT_CONNECTION_MODE", "webrtc"),
)
