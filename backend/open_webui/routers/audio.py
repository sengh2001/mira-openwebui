...
class PipecatConfigForm(BaseModel):
    PIPECAT_ENABLED: bool
    PIPECAT_API_URL: str
    PIPECAT_CONNECTION_MODE: str


class AudioConfigUpdateForm(BaseModel):
    tts: TTSConfigForm
    stt: STTConfigForm
    pipecat: Optional[PipecatConfigForm] = None
...
async def get_audio_config(request: Request, user=Depends(get_admin_user)):
    return {
        "pipecat": {
            "PIPECAT_ENABLED": request.app.state.config.PIPECAT_ENABLED,
            "PIPECAT_API_URL": request.app.state.config.PIPECAT_API_URL,
            "PIPECAT_CONNECTION_MODE": request.app.state.config.PIPECAT_CONNECTION_MODE,
        },
        "tts": {
...
async def update_audio_config(
    ...
    if form_data.pipecat:
        request.app.state.config.PIPECAT_ENABLED = form_data.pipecat.PIPECAT_ENABLED
        request.app.state.config.PIPECAT_API_URL = form_data.pipecat.PIPECAT_API_URL
        request.app.state.config.PIPECAT_CONNECTION_MODE = form_data.pipecat.PIPECAT_CONNECTION_MODE
